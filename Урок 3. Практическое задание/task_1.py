...
@time_of_function
def list_app(i=1):
    for i in range(i):  #О(n)
        my_list.append(random.choice(range(1000, 10000000000)))  #О(1)
    return my_list  #О(1)
...
def dict_app(i=1):
    for i in range(i):   #О(n)
        my_dict[i] = (random.choice(range(1000, 10000000000)))   #О(1)
    return my_dict    #О(1)
...
Видимо из-за расчёта хеша для эллементов. 
"""